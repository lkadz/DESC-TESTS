...
Loads eq_fixed.h5, initialises NUM_COILS modular coils (8 when ESCALATE=True)
as FourierXYZCoils, then minimises QuadraticFlux + CoilLength + CoilCurvature
(+ CoilSetMinDistance when ESCALATE).
Output: coilset.h5
"""
