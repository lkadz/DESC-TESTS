"""Stage 1: solve a 2-NFP fixed-boundary stellarator equilibrium.

Configuration: precise_QA boundary with its non-axisymmetric shaping attenuated
by SHAPE_FACTOR (NFP=2, a≈0.2 m), parabolic pressure, linear iota.
Output: eq_fixed.h5
"""
